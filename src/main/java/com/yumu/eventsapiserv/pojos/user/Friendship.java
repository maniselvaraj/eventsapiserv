...
public class Friendship {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Friendship) == false) {
            return false;
        }
        Friendship rhs = ((Friendship) other);
    ...
    public enum Status {
        ...
        private final static Map<String, Friendship.Status> CONSTANTS = new HashMap<String, Friendship.Status>();

        static {
            for (Friendship.Status c: values()) {
        ...
        @JsonCreator
        public static Friendship.Status fromValue(String value) {
            Friendship.Status constant = CONSTANTS.get(value);
            if (constant == null) {
